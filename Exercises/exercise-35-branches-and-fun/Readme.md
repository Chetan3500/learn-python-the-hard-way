...
Let check what this code do.

## Exerices

1. Create an ex35.py and write following
    ```py
    def gold_room():
...
That fat bear is in front of another door.
...
This example shows that function and if-statement, to create branches, can be used to create a loop too.